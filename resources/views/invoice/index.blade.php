    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-sm customer-table" id="invoiceTable" width="100%" cellspacing="0">
                    <thead>
                    ...
                    <tbody>
                        @forelse ($invoices as $invoice)
                            <tr class="text-center">
                                ...
                                <td>
                                    @if ($invoice->due_amount == 0)
                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#report">Download
                                            Report</a>
                                    @else
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reportLabel">Modal title</h5>
