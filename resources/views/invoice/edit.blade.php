                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.invoice.update', $invoice->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-2">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="invoice_no" name="invoice_no" value="{{ $invoice->invoice_no }}"
                                                    readonly>
                                                @error('invoice_no')
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-2">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ $invoice->next_inspection_date }}">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select
                                                    ...
                                                    @foreach ($invoices as $inv)
                                                        <option value="{{ $inv->id }}"
                                                            @if ($invoice->id == $inv->id) selected @endif>
                                                            {{ $inv->title }}</option>
                                                    @endforeach
                                                </select>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <input type="text"
                                        class="form-control item-name @error('title') is-invalid @enderror"
                                        name="title" placeholder="Item name" value="{{ $invoice->title }}" required>
                                    @error('title')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                    <textarea class="form-control mt-2 item-desc @error('description') is-invalid @enderror" name="description" placeholder="Description" rows="2">{{ $invoice->description }}</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number"
                                                ...
                                                value="{{ $invoice->total_amount }}" id="total" name="total_amount">
                                            @error('total_amount')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number"
                                                ...
                                                value="{{ $invoice->paid_amount }}" id="paid" name="paid_amount">
                                            @error('paid_amount')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-2 row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="number"
                                                ...
                                                id="due" value="{{ $invoice->due_amount }}" name="due_amount"
                                                readonly>
                                            @error('due_amount')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('invoice_note') is-invalid @enderror" name="invoice_note" rows="3"
                                    placeholder="Thanks for your business!">{{ $invoice->invoice_note }}</textarea>
                                @error('invoice_note')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#total').val({{ $invoice->total_amount }});
            $('#paid').val({{ $invoice->paid_amount }});
            updateInvoice();
